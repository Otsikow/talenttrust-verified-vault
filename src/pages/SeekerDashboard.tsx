...
const SeekerDashboard = () => {
  ...
  const recentDocuments = [
    { id: 1, name: "Bachelor's Degree - Computer Science", type: "degree", status: "verified", university: "Stanford University" },
    { id: 2, name: "AWS Cloud Practitioner Certificate", type: "certificate", status: "verified", issuer: "Amazon Web Services" },
    { id: 3, name: "Employment Reference - Google", type: "reference", status: "pending", issuer: "Google Inc." },
    { id: 4, name: "Portfolio - Mobile App Project", type: "work_sample", status: "verified", issuer: "Self" }
  ];

  const jobRecommendations = [
    { id: 1, title: "Senior Software Engineer", company: "TechCorp", location: "San Francisco, CA", verificationRequired: true, match: 95 },
    { id: 2, title: "Full Stack Developer", company: "StartupXYZ", location: "Remote", verificationRequired: true, match: 88 },
    { id: 3, title: "Software Architect", company: "BigTech Inc", location: "Seattle, WA", verificationRequired: false, match: 92 }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Your verification profile is {Math.round((verificationStats.verified / verificationStats.total) * 100)}% complete</p>
        </div>
                    ...
                    <div key={doc.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{doc.issuer || doc.university}</p>
                        </div>
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {jobRecommendations.map((job) => (
                    <div key={job.id} className="border rounded-lg p-6 hover:border-blue-200 transition-colors">
